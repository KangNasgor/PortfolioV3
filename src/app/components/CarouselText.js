...
/*
EXPLANATION :
  the useEffect hook will set the index based on the text, in const textInterval the index value will match the text's length because of the module operator
  ...
  the most important part is the transform style where it will make the texts go up and up and after reaching the laxt text the div will go down because of index * 50
