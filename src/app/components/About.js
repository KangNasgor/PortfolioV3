...
export default function About() {
  ...
  return (
    <div className="h-screen bg-gradient-to-b black flex items-center" id="about">
      <div className="flex flex-col md:flex-row w-4/5 bg-zinc-800 mx-auto rounded p-6 md:p-9 justify-center gap-6 md:gap-20 items-center">
